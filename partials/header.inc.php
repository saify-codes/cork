...
<head>
    ...
    <?php foreach ($external_css ?? [] as $css) echo "<link rel='stylesheet' href='$css'>"; ?>
    <title>Cork House Lettings</title>
</head>

<body>
    <nav class="navbar" role="navigation" style="box-shadow: 0 2px 5px 0 #0003;">
        ...
        <div id="navbarBasicExample" class="navbar-menu">
            ...
            <div class="navbar-end">
                <div class="navbar-item">
                    <?php if (Auth::check()) : ?>
                        <span class="tag is-primary is-light"><?= Auth::user()['role'] ?></span>
                        <div class="dropdown">
                            <img class="image is-48x48" style="max-height: 48px;" src="https://thumbs.dreamstime.com/b/businessman-icon-vector-male-avatar-profile-image-profile-businessman-icon-vector-male-avatar-profile-image-182095609.jpg" alt="avatar">
                            <ul>
                                <li><a style="color:#000" class="link" href="/dashboard">Dashboard</li>
                                <li><a style="color:#000" class="link" href="/logout">Logout</a></li>
                            </ul>
                        </div>
