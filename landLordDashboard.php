...
<main>
    <aside>
        <ul>
            ...
            <li class="is-flex is-align-content-center" style="gap: 0.5rem;"><box-icon name='user-detail' type='solid'></box-icon>Earnings</li>
            <li class="is-flex is-align-content-center" style="gap: 0.5rem;"><box-icon name='user-circle' type='solid'></box-icon>Testimonial</li>
        </ul>
    </aside>
    <div class="content">
        <form class="mb-6" method="post">
                ...
                <div class="control">
                    <div class="select" style="width: 100%;">
                        <select name="category" style="width: 100%;">
                            <option value="1 bed" selected>1 Bed</option>
            ...
            <div class="field">
                ...
                <div class="control">
                    <input class="input" type="text" name="area" placeholder="Enter area" />
                </div>
                <p class="help is-danger"><?php echo $area_err; ?></p>
            </div>
